...
export default async function Home() {
  const thoughts = await api("/thoughts"); // becomes https://backend1-xvn0.onrender.com/api/thoughts
  ...
  return (
    <main className="max-w-2xl mx-auto p-6 space-y-6">
      ...
      <a href="/submit" className="inline-block mt-6 underline opacity-80 hover:text-accent">
        Submit a thought
      </a>
    </main>
  );
